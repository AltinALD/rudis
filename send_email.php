...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $mail->addAddress('jasirosmani800@gmail.com'); // TODO: Add Warteck/owner email(s)
        $mail->addAddress('altinejup@gmail.com'); // Optional: backup
        $mail->addAddress('jasir-osmani@t-online.de'); // Optional: backup
